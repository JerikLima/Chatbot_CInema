...
def create_movies_image(movies):
    ...
    # Carregar as imagens dos posters e os dados dos filmes
    for movie in movies:
    ...
    padding_between_poster = 700  # Espaço entre os posters
    ...
    padding_session_poster = 50   # Espaço vertical entre os horários e o poster
    
    # Tamanhos das fontes
    font_size_title = 100
    font_size_session = 100

    # Carregar a fonte padrão
    font_title = ImageFont.truetype("fonts/ARIALBD.TTF", font_size_title)
    font_session = ImageFont.truetype("fonts/ARIALBD.TTF", font_size_session)
    ...
    for i in range(num_movies):
        ...
        title_x = x_offset + (poster_width - title_width) // 2
